...
\label{sec:notations}
We note $\mathbb{K}$ any Abelian\footnote{Commutative.} field and call its
elements scalars. $\mathbb{R}$ is the Abelian field of real numbers and
$\mathbb{C}$ is the Abelian field of complex numbers. The unit pure imaginary
number $\sqrt{-1}\in\mathbb{C}$ is denoted $\iu$ and the Euler constant
...
always second countable. Moreover ervery second countable locally compact
...
$W^\transpose :x^\adjoint\mapsto x^\adjoint(W)$.
\paragraph{}
...
\begin{table}
    ...
    \begin{tabularx}{\textwidth}{cX}
        ...
        \endhead
            ...
            \inner{x_j, z_j}_{\mathcal{H}_i}$~\citep[see]{avramidi2000notes}.
            \\
