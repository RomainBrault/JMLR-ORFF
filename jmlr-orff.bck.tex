...
\begin{abstract}%   <- trailing '%' for backward compatibility of .sty file
    ...
    introduced for translation-invariant scalar-valued kernels, to \emph{\acl{OVK}s}, in the general context of Locally Compact Abelian groups. Coming up with an approximated operator-valued feature map converts the nonparametric kernel-based model into a linear model in a finite-dimensional space.
\end{abstract}
...
Among the different families of tools that currently allow to address multiple outputs prediction, Operator-Valued Kernel methods \citep{Micchelli2005,Carmeli2010,Kadri_aistat10,
Brouard2011,Alvarez2012} benefit from a well founded theoretical background while being flexible enough to handle a large variety of problems. Operator-Valued Kernels extend the classic scalar-valued kernels to functions
...
we study feature map approximations of  \acsp{OVK} and the corresponding shallow architectures,
