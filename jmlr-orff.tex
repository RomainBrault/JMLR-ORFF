...
%Widely used in approximation theory \cite{Wahba} and in machine learning \cite{Scholpkoft} The theory of \acsp{OVK} which extends the scalar-valued kernel was
%first developped by \citet{Pedrick57} in his Ph.~D Thesis.
 Since then it has
...
\paragraph{}
We present a construction of Operator-valued Random Feature maps, called \acs{ORFF maps} and their associated images, the Operator-valued Ranfom Foufrer Features, called \asc{ORFFs} .
%such that $f:
